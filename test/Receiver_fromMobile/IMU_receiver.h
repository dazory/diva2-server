...
#include "mscl/mscl.h"
//#include "../service/IMU_Packet.h" //클래스로 주고받을 때 사용했던 헤더
#include "../service/Timestamp.h"

#include <google/protobuf/text_format.h>
#include <google/protobuf/util/json_util.h>
#include "../protobuf/sensors.pb.h" //protobuf

using namespace std;

class IMU_ReceiverThread
{
public:
    ~IMU_ReceiverThread(){}
    IMU_ReceiverThread(){}
    void run(void *context); //void IMU_StoringThread::run(void *context)
    void stop();
    Timestamp ts;
...
// void IMU_StoringThread::run(void *context)
// {
//     printf("imu.run (in IMU_StoringThread::run)\n");
//     zmq::socket_t imu_rep(*(zmq::context_t *)context, ZMQ_REP);
//     imu_rep.bind("tcp://*:5564"); //165.246.39.124(cvlab2)
//     printf("imu. Listening (in IMU_StoringThread::run)\n");
